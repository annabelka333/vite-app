...
const LangComponent = () => {
  ...
  const buttonBgColor = currentLanguageLabel === 'en' ? 'bg-green-200' : currentLanguageCode === 'es' ? 'bg-green-200' : 'bg-green-200';
  ...
  return (
    <div className="relative flex px-4 pt-2 justify-end" ref={dropdownRef}>
      ...
      {isOpen && (
        <ul
          className="rigin-top-right absolute right-4 top-full z-10 mt-2 w-56 rounded-md bg-white shadow-lf ring-1 ring-black ring-opacity-5 focus:outline-none"
          role="menu"
